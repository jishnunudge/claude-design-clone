...
- Mouse-interactive world building
...
**Philosophy**: The beauty of systems surpasses the beauty of individuals
**Key characteristics**:
...
**Key characteristics**:
- Elegance of concept prototypes
...
**Philosophy**: Design is not filling — it is clearing
**Key characteristics**:
...
**Good — Mood-driven (output is diverse and textured):**
```
...
**Integration with image-to-slides**: PPT scenarios can directly reference styles from this file and execute generation via the image-to-slides skill
