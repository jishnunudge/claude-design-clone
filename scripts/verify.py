#!/usr/bin/env python3
"""
verify.py — Playwright wrapper for verifying HTML outputs from claude-design
...
Usage:
    ...
    python verify.py deck.html --slides 10                  # Slide-by-slide screenshots (first 10)
...
def verify_html(html_path, viewports=None, slides=0, output_dir=None, show=False, wait=2000):
    ...
    with sync_playwright() as p:
        ...
        for viewport in viewports:
            ...
            if show:
                print("  (Browser window staying open, press Enter to close...)")
                input()
...
def main():
    ...
    parser.add_argument("--output", default=None,
                        help="Output directory (default: screenshots/ in the same directory as the HTML file)")
